...
/usr/sbin/grub2-install --target=i386-pc --locales=en@piglatin --fonts=ascii --install-modules="multiboot normal part_msdos ext2" --modules="multiboot normal part_msdos ext2" --boot-directory=/mnt/boot $1 
exit 0
